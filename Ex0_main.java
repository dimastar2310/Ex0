...
import ex0.algo.ElevatorTester_3;
...
public class Ex0_main {
    public static Long ID0=205596890L, ID1 = 324466671L, ID2 = null;
    public static void main(String[] ar) {
        ...
        ElevatorAlgo ex0_alg = new ElevatorTester_3(Simulator_A.getBuilding());    // Shabat Elev with two trick - replace with your code;
    ...
    private static String codeOwner() {
        String owners = "Netanel Cohen, Dimitri Sanin";
